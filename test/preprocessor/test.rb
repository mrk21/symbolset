  ...
  module Processor
    ...
    class Test_SYMBOLSET_PP_SYMBOL_LIST < TestBase
      def test_output
        ...
        SUBJECT_CPP
          static constexpr typename base_type::value_type a = static_cast<typename base_type::value_type>(base_type::SIZE + 0);
          static constexpr typename base_type::value_type b = static_cast<typename base_type::value_type>(base_type::SIZE + 1);
          static constexpr typename base_type::value_type c = static_cast<typename base_type::value_type>(base_type::SIZE + 2);
        EXPECTED_CPP
      end
    end
